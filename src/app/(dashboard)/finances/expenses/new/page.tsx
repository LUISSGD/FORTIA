...
export default function NewExpensePage() {
  ...
  const [form, setForm] = useState({
    amount: "", currency: "PEN", category: "OTHER", description: "", vendor: "", date: format(new Date(), "yyyy-MM-dd"),
  })
              ...
              <div className="flex gap-2 mt-1">
                {["PEN", "USD"].map((cur) => (
                  <button
                    ...
                    className={`flex-1 py-2 rounded-lg border text-sm font-semibold transition-colors ${form.currency === cur ? "bg-red-500 text-white border-red-500" : "border-gray-300 text-gray-600 hover:border-red-400"}`}
                  >
